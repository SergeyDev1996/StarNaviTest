"""
Django settings for StarNaviTest2 project.
...
SECRET_KEY = "django-insecure-*z@lvcyx%sxv(e$8!0_r(dv5-!96ynd=s*n#w$b(t3cfmx)^c%"
...
WSGI_APPLICATION = "StarNaviTest2.wsgi.application"
